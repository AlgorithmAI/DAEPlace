 ...
 * @author Xu Li
 * @date   10 2024
 * @brief  Compute density overflow with cell-by-cell parallelization on HIP
 */
...
template <typename T>
int computeDensityOverflowMapHipByNodeLauncher(
        ...
        )
{
    ...
    AT_DISPATCH_FLOATING_TYPES(pos.type(), "computeDensityOverflowMapHipByNodeLauncher", [&] {
            computeDensityOverflowMapHipByNodeLauncher<scalar_t>(
