        ...
        at::Tensor net_mask)
{
    ...
    AT_DISPATCH_FLOATING_TYPES(pos.type(), "computeHPWLHipLauncher", [&] {
            computeHPWLHipLauncher<scalar_t>(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &DREAMPLACE_NAMESPACE::hpwl_forward, "HPWL forward (HIP)");
}
