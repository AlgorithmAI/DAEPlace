...
class HPWLOpTest(unittest.TestCase):
    def test_hpwlRandom(self):
        ...
        if torch.cuda.device_count(): 
            ...
            hpwl_value = custom_hip.forward(pin_pos_var.cuda())
            print("hpwl_value hip = ", hpwl_value.data.cpu().numpy())
        ...
        if torch.cuda.device_count(): 
            ...
            hpwl_value = custom_hip_atomic.forward(pin_pos_var.cuda())
            print("hpwl_value hip atomic = ", hpwl_value.data.cpu().numpy())
            np.testing.assert_allclose(hpwl_value.data.cpu().numpy(), golden_value)
